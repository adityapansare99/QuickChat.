...
const ChatContainer = ({ isDarkTheme }) => {
  ...
  return selectedUser ? (
    <>
      <div
        className={`h-full max-md:flex max-md:flex-col overflow-scroll relative transition-colors duration-300 ${
          isDarkTheme ? "backdrop-blur-lg" : "bg-white/40 backdrop-blur-lg"
        }`}
      >
        <div
          className={`flex max-md:fixed max-md:top-0 max-md:right-0 max-md:left-0 h-16 items-center gap-3 py-3 mx-4 border-b transition-colors duration-300 ${
        ...
        >
          ...
          />
          <img
            src={isDarkTheme ? assets.help_icon : assets.about_light}
            alt=""
            ...
            >
              {message.image ? (
                <img
                  ...
                  className={`max-w-[230px] rounded-2xl overflow-hidden mb-8 shadow-lg transition-transform hover:scale-105 cursor-pointer ${
                    isDarkTheme
        ...
        <div
          className={`absolute max-md:bottom-0 max-md:fixed left-0 right-0 flex items-center gap-3 p-3 transition-colors duration-300 ${
            isDarkTheme ? "" : "bg-white/60"
          }`}
        >
          <div
            className={`rounded-full px-4 flex flex-1 items-center transition-all duration-200 ${
              isDarkTheme
          ...
          >
            ...
            <label htmlFor="image">
              <img
                src={isDarkTheme ? assets.gallery_icon : assets.light_image}
                alt=""
    ...
    <div
      className={`flex items-center flex-col justify-center gap-4 max-md:hidden transition-colors duration-300 ${
        isDarkTheme
          ? "bg-white/10"
